...
class Data(object):
    ...
    def _proprecess(self):
        ...
        """
        data = []
        with open(FILE_PATH+"/data/songs.json",'r',encoding=‘utf-8’ ,errors='ignore') as f:
        ...
        with open(FILE_PATH+"/temp/data.json", "w",encoding=‘utf-8’,errors='ignore') as f:  # 保存为临时文件, 以便torchtext读取
